...
- Simple CityName suggestions while typing the input. 
- Weather icons for conditions.
- Dark/Light mode toggle that switches the entire theme.
- Shareable links via the URL query, for example: ?q=mumbai.
- Geolocation to fetch weather for the current position.
